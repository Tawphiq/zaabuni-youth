    ...
    <div data-aos="fade-up" name="about" className="bg-[url(./assets/zaabout.webp)] bg-no-repeat bg-cover  bg-center lg:bg-topd min-h-screen w-full">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 text-lg">
          {/* <img src={zaabout} alt="" /> */}
          <h1 className="text-5xl ml-4 text-yellow-950b text-black mb-4">We believe in the power of community and collaboration</h1>
          <p className="mb-4 text-2xl text-white mx-4">
