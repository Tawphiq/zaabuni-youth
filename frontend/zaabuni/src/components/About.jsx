...
const About = () => {
  ...
  return (
    <div data-aos="fade-up" name="about" className="bg-teal-100 h-screen lg:h-full w-full p-6 font-nunito">
      <div className="max-w-7xl mx-auto">
        <div className="mb-2 text-4xl">
          <h4 className="text-3xl font-bold mb-4 text-gray-600">About Us</h4>
          {/* <img src={zabout} alt="" className='rounded-2xl lg:hidden' /> */}
        </div>
        <div className="grid lg:grid-cols-2 lg:gap-6 text-lg">
          <img src={zabout} alt="" className='rounded-2xl' />
          <p className="lg:grid lg:items-center mb-4 text-xl text-black pb-10">
