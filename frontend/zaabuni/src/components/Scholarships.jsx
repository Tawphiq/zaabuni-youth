...
import zaasc from '../assets/zaasc.jpg'
...
const Scholarships = () => {
  ...
  const scholarships = [
    {
      ...
      `,
      image: zaasc, // Add your image URL here
      details: [
  ...
  const handleReadMore = (index) => {
    navigate(`/scholarships/${index}`, { state: { scholarships } });
  };
  ...
  return (
    <div name="scholarships" className="container mx-auto p-6">
